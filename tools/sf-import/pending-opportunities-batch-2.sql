-- Opportunities layouts batch 2/4 (6 layouts)
DO $$
DECLARE
...
-- Layout: MFES-2024  →  RT picklist_value = MFES_2024
  SELECT id INTO rt_id FROM public.picklist_values WHERE picklist_object = 'opportunities' AND picklist_field = 'record_type' AND picklist_value = 'MFES_2024' LIMIT 1;
  ...
  INSERT INTO public.page_layouts (
    ...
    '', 'MFES-2024', 'opportunities',
    'record_detail', true,
    'Imported from SF Layout: Opportunity-MFES-2024',
    rt_id, fb, fb, false
  ) RETURNING id INTO layout_id;
...
-- Layout: MFES-2025-Equipment  →  RT picklist_value = MFES_2025_Equipment
  SELECT id INTO rt_id FROM public.picklist_values WHERE picklist_object = 'opportunities' AND picklist_field = 'record_type' AND picklist_value = 'MFES_2025_Equipment' LIMIT 1;
  ...
  INSERT INTO public.page_layouts (
    ...
    '', 'MFES-2025-Equipment', 'opportunities',
    'record_detail', true,
    'Imported from SF Layout: Opportunity-MFES-2025-Equipment',
    rt_id, fb, fb, false
  ) RETURNING id INTO layout_id;
...
-- Layout: MFES-Mechanical  →  RT picklist_value = MFES_Mechanical
  SELECT id INTO rt_id FROM public.picklist_values WHERE picklist_object = 'opportunities' AND picklist_field = 'record_type' AND picklist_value = 'MFES_Mechanical' LIMIT 1;
  ...
  INSERT INTO public.page_layouts (
    ...
    '', 'MFES-Mechanical', 'opportunities',
    'record_detail', true,
    'Imported from SF Layout: Opportunity-MFES-Mechanical',
    rt_id, fb, fb, false
  ) RETURNING id INTO layout_id;
