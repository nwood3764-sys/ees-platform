...
-- Layout: WI-IRA-SF-HOMES-AUDIT  →  RT picklist_value = WI_IRA_SF_HOMES_AUDIT
  SELECT id INTO rt_id FROM public.picklist_values WHERE picklist_object = 'assessments' AND picklist_field = 'record_type' AND picklist_value = 'WI_IRA_SF_HOMES_AUDIT' LIMIT 1;
  ...
  INSERT INTO public.page_layouts (
    ...
    '', 'WI-IRA-SF-HOMES-AUDIT', 'assessments',
    'record_detail', true,
    'Imported from SF Layout: Assessment__c-WI-IRA-SF-HOMES-AUDIT',
    rt_id, fb, fb, false
