-- =============================================================================
-- Project Portal — expose work-step photos
--
-- Each work step now returns its photos (from the photos table, linked by
-- photos.work_step_id): id, full file_url, thumbnail_url, caption, photo_type
-- (before / after / reference). Lets the portal show clickable photo thumbnails
-- per work step. Everything else unchanged.
-- =============================================================================
