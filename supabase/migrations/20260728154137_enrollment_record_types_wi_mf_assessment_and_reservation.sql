-- Add two Wisconsin IRA Multi-Family enrollment record types.
--   1. Wisconsin IRA Multi-Family Assessment Pre-Approval
--   2. Wisconsin IRA Multi-Family HOMES Project Reservation
...
from (values
  ('enrollments', 'record_type', 'wi-ira-mf-assessment-pre-approval',
   'Wisconsin IRA Multi-Family Assessment Pre-Approval', 'WI', 22),
  ('enrollments', 'record_type', 'wi-ira-mf-homes-project-reservation',
   'Wisconsin IRA Multi-Family HOMES Project Reservation', 'WI', 24)
