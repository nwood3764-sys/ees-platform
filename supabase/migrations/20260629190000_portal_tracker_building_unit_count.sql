-- =============================================================================
-- Project Portal — add unit_count per building (for the property dashboard)
--
-- The building-level tracker dropped the unit list, but the property dashboard
-- needs a real unit count. Add unit_count to each building object (count of
-- non-deleted units under it). Everything else unchanged.
-- =============================================================================
