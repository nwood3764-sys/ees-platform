...
export const OPPORTUNITIES = [
  { id:'OPP-00001', name:'MF-HOMES-North Willow Apts-Building A',       property:'North Willow Apartments',  owner:'Marcus Reid',  stage:'Reservation Obtained',      program:'WI-IRA-MF-HOMES', amount:142000, closeDate:'2026-06-30', units:20, state:'WI' },
  { id:'OPP-00002', name:'MF-HEAR-Capitol View Townhomes-Bldg 1-6',      property:'Capitol View Townhomes',   owner:'Priya Nair',   stage:'Assessment Scheduled',       program:'WI-IRA-MF-HEAR',  amount:89000,  closeDate:'2026-08-15', units:24, state:'WI' },
  { id:'OPP-00003', name:'MF-HOMES-River Bluff Senior Living-Bldg 1',    property:'River Bluff Senior Living',owner:'Marcus Reid',  stage:'Application Submitted',      program:'WI-IRA-MF-HOMES', amount:210000, closeDate:'2026-05-01', units:42, state:'WI' },
  { id:'OPP-00004', name:'FOE-Eastside Commons-All Buildings',            property:'Eastside Commons',         owner:'Lisa Tanaka',  stage:'Decision Maker Identified',  program:'WI - FOE',        amount:55000,  closeDate:'2026-10-30', units:60, state:'WI' },
  { id:'OPP-00005', name:'Denver-Aspen Court Residences-All Buildings',   property:'Aspen Court Residences',   owner:'Priya Nair',   stage:'Project In Progress',        program:'CO - Denver',     amount:320000, closeDate:'2026-07-15', units:108,state:'CO' },
  { id:'OPP-00006', name:'NC-IRA-HOMES-Pinehurst Village-All',            property:'Pinehurst Village',        owner:'Lisa Tanaka',  stage:'Application Submitted',      program:'WI-IRA-SF-HOMES', amount:175000, closeDate:'2026-06-01', units:72, state:'NC' },
  { id:'OPP-00007', name:'MF-HOMES-Lakewood Terrace-Phase 1',             property:'Lakewood Terrace',         owner:'Marcus Reid',  stage:'Outreach Active',            program:'WI-IRA-MF-HOMES', amount:180000, closeDate:'2026-12-01', units:96, state:'WI' },
  { id:'OPP-00008', name:'MI-IRA-HOMES-Oak Park Apartments-All',          property:'Oak Park Apartments',      owner:'Priya Nair',   stage:'Enrollment In Progress',      program:'MI-IRA-MF-HOMES', amount:98000,  closeDate:'2026-09-01', units:55, state:'MI' },
  { id:'OPP-00009', name:'WI-IRA-HOMES-North Willow Apts-Building B',    property:'North Willow Apartments',  owner:'Marcus Reid',  stage:'Reservation Obtained',       program:'WI-IRA-MF-HOMES', amount:138000, closeDate:'2026-07-30', units:20, state:'WI' },
];
