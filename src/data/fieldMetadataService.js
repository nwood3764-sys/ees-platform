...
export function guessPrefix(tableName) {
  const map = {
    ...
    service_provider_trades: 'spt',
    service_provider_onboarding_step_templates: 'spot',
    service_provider_onboarding_steps: 'spos',
...
function guessNameColumn(tableName) {
  const map = {
    ...
    price_book_entries: 'price_book_entry_name',
    ...
    service_provider_trades: 'spt_name',
    service_provider_onboarding_step_templates: 'spot_name',
    service_provider_onboarding_steps: 'spos_name',
