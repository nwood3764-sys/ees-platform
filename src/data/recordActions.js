...
export const ACTION_REGISTRY = Object.freeze({
  ...
  // Surfaces "Log a Call" in the record header so it's reachable from any tab
  // (the same action also lives in the Activity timeline composer). Writes a
  // Call activity via the LogCallModal → log_activity RPC.
  log_a_call: {
    key:                 ACTION_KEYS.LOG_A_CALL,
    label:               'Log a Call',
    icon:                'M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.94.36 1.86.68 2.75a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.33-1.33a2 2 0 0 1 2.11-.45c.89.32 1.81.55 2.75.68A2 2 0 0 1 22 16.92z',
    color:               ACTION_COLORS.EMERALD,
