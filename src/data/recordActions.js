...
export const ACTION_KEYS = Object.freeze({
  ...
  NOTIFICATION_OF_COMBUSTION_SAFETY:        'notification_of_combustion_safety',
...
export const ACTION_REGISTRY = Object.freeze({
  ...
  notification_of_combustion_safety: {
    key:                 ACTION_KEYS.NOTIFICATION_OF_COMBUSTION_SAFETY,
    label:               'Notification of Combustion Safety',
    icon:                'M14 3H6a2 2 0 00-2 2v14a2 2 0 002 2h12a2 2 0 002-2V9l-6-6z M14 3v6h6 M9 13h6 M9 17h4',
    color:               ACTION_COLORS.EMERALD,
    applicableObjects:   ['buildings'],
    defaultTier:         'menu',
    defaultSortOrder:    27,
    isAvailable: ({ tableName, editing }) => !editing && tableName === 'buildings',
  },
