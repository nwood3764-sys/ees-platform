...
import { hasSubmissionReport } from '../lib/enrollmentSubmissionReport'
...
export const ACTION_KEYS = Object.freeze({
  ...
  GENERATE_SUBMISSION_RECORD:               'generate_submission_record',
...
export const ACTION_REGISTRY = Object.freeze({
  ...
  // Enrollment Submission Record — what was filed with the program, and the
  ...
  generate_submission_record: {
    key:                 ACTION_KEYS.GENERATE_SUBMISSION_RECORD,
    label:               'Generate Submission Record',
    ...
    // not been filed yet.
    isAvailable: ({ tableName, editing, record }) =>
      !editing && !!record?.id && hasSubmissionReport(tableName),
  },
