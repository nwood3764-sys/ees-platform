...
export function loadPicklists() {
  ...
  _picklistPromise = (async () => {
    // Paginated: picklist_values is at 921 rows and climbing as we add
    // record types, status lifecycles, and program/state values. Hit
    // the 1000-row PostgREST cap and the entire app starts showing
    // "—" for resolved picklist labels in any view that uses the
    // tail of the table.
