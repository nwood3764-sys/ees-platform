...
const OPP_VIEWS = [{ id:'QOP-01', name:'All Opportunities', filters:[], sortField:'name', sortDir:'asc' }]
...
export default function QualificationModule({ selectedRecord: navSelectedRecord, sectionFromUrl, onNavigateToRecord, onCloseRecord, onSectionChange, onReplaceRecord, onOpenSetup } = {}) {
  ...
  return (
    <div style={{ flex:1, display:'flex', flexDirection:'column', overflow:'hidden' }}>
      ...
      <SectionTabs sections={SECTIONS} moduleId="qualification" active={sec} onChange={changeSection} counts={counts} urgentSections={urgentSections} />
