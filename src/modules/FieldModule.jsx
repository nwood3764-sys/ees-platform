...
export default function FieldModule({ selectedRecord: navSelectedRecord, sectionFromUrl, onNavigateToRecord, onNavigateToModule, onCloseRecord, onSectionChange, onReplaceRecord, onOpenSetup } = {}) {
  ...
  // BACK to whatever preceded it (Nicholas, 2026-08-25). Only the local-state
  // fallback path has a record to clear here.
  ...
  return (
    <div style={{ flex:1, display:'flex', flexDirection:'column', overflow:'hidden' }}>
      ...
      <SectionTabs sections={SECTIONS} moduleId="field" active={sec} onChange={(s) => { changeSection(s); setReviewWorkOrder(null); }} counts={counts} urgentSections={urgentSections} />
