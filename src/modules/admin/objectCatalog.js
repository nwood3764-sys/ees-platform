...
export const OBJECT_CATALOG = [
  ...
  { table: 'enrollments',                   label: 'Enrollment',                  pluralLabel: 'Enrollments',                  module: 'CRM & Enrollment',        description: 'A property\'s enrollment into a program — record types are state-scoped programs.' },
  ...
  { table: 'opportunity_line_items',        label: 'Opportunity Line Item',       pluralLabel: 'Opportunity Line Items',       module: 'CRM & Enrollment',        description: 'Charge line on an opportunity — a program measure or incentive, priced through a price book entry.' },
  ...
  { table: 'service_provider_trades',        label: 'Service Provider Trade',      pluralLabel: 'Service Provider Trades',      module: 'Service Providers',      description: 'A trade a service-provider account performs (multi-select; one row per trade, one marked primary).' },
  { table: 'service_provider_onboarding_step_templates', label: 'Onboarding Step Template', pluralLabel: 'Onboarding Step Templates', module: 'Service Providers', description: 'Configurable default onboarding steps (documents, interview, training) instantiated on each application.' },
  { table: 'service_provider_onboarding_steps', label: 'Onboarding Step',           pluralLabel: 'Onboarding Steps',            module: 'Service Providers',      description: 'Per-application onboarding checklist step; the portal invite is gated on required steps being complete.' },
  ...
  { table: 'submittal_document_text_blocks', label: 'Submittal Document Wording',  pluralLabel: 'Submittal Document Wording',   module: 'Configuration',         description: 'Program wording used on submittal documents (measure descriptions, acknowledgments, footers). Scope a block to an opportunity record type to override it for that program.' },
  { table: 'submittal_document_templates', label: 'Submittal Document Template', pluralLabel: 'Submittal Document Templates', module: 'Configuration',         description: 'A submittal document as an ordered list of sections. Copy one to build another program\'s version.' },
  { table: 'submittal_document_template_sections', label: 'Submittal Document Section', pluralLabel: 'Submittal Document Sections', module: 'Configuration',   description: 'One section of a submittal document template, with its editable content in Config.' },
  { table: 'stage_document_requirements',  label: 'Stage Document Requirement', pluralLabel: 'Stage Document Requirements', module: 'Configuration',         description: 'Which documents a record needs at a given stage. Object-agnostic: point it at any table plus one of that object\'s status/stage values.' },
