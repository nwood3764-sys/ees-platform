...
- **Project Paperwork port (queued workstream, DECIDED 2026-07-26):** build HOMES invoice/proposal generation into LEAP from the standalone Audit Template Builder — complete spec, verified integration map, and kickoff prompt in `docs/leap-project-paperwork-port.md`. Start with Phase 1 (paperworkService + generate_paperwork record action + modal on projects).
