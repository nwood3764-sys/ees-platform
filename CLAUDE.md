...
- **HARD RULE (Nicholas, 2026-07-13): customers NEVER receive email/SMS about work orders or service appointments — no booking confirmations, reminders, or lifecycle updates, no exceptions.** The entire pathway was removed in `20260713121244_remove_customer_work_order_notifications.sql`: both SA notification triggers dropped, `dispatch_due_reminders` cron + function dropped, `enqueue_notification` dropped (fire-notification edge fn now has zero callers), customer templates NT-00001–NT-00013 deactivated (NT-00014 dispatcher-internal kept). Advisor baseline now ~172. Do NOT rebuild any customer-facing work-order notification without an explicit new decision from Nicholas.
