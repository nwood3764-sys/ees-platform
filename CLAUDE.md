...
- Help article **HA-00141** (`creating-related-records-data-inheritance`). NOTE: the layout-config change is live in prod ahead of the frontend — until this branch's PR merges, the live bundle treats the new kind as unknown and renders those opportunity pickers as a disabled hint (safe-closed, not universal). Merge promptly.
